...
class SpaceInvaders():
    ...
    def __init__(self, display : bool = False):
        ...
        self.sizeInterval = 80
        self.nIntervalsX = (self.screen_width)//self.sizeInterval
        self.nIntervalsY = (self.screen_height)//self.sizeInterval
        # caption and icon
    ...
    def get_state(self):
        ...
        invaderX = math.floor(self.get_invaders_X()[0]/self.sizeInterval)
        invaderY = math.floor(self.get_invaders_Y()[0]/self.sizeInterval)
        playerX = math.floor(self.get_player_X()/self.sizeInterval)
        bulletY = math.floor(self.get_bullet_Y()/self.sizeInterval) if self.get_bullet_Y() < self.screen_height else 0
        return (invaderX if invaderX < self.nIntervalsX else invaderX-1, invaderY if invaderY < self.nIntervalsY else invaderY-1, playerX, bulletY if bulletY < self.nIntervalsY else bulletY-1, bulletState)
